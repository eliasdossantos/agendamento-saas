 ...
 * StoreUnidadeRequest
 * ─────────────────────────────────────────────────────────────────────────────
 * Centraliza validação, sanitização e autorização da criação de uma unidade.
 *
 * Fluxo automático ao instanciar:
 *   new StoreUnidadeRequest()
 *     → authorize()
 *     → sanitize()
 *     → validate()
 *
 * Uso no Controller:
 *   $request = new StoreUnidadeRequest();
 *
 *   if ($request->fails()) {
...
class StoreUnidadeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug'              => 'required|min:2|max:150|unique:unidades,slug',
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.unique'        => 'Este slug já está em uso por outra unidade.',
            ...
            'imagem.mimes'       => 'A imagem deve ser um arquivo jpg, jpeg, png ou webp.',
            ...
            'intervalo_minutos.integer'  => 'O intervalo deve ser um número inteiro.',
