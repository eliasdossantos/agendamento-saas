...
<head>
    ...
    <title>404 — Página não encontrada | Sistema</title>
    <link
...
<body>
        ...
        <div class="suggestions-box">
            ...
            <ul class="suggestions-list">
                ...
                <li>
                    ...
                    <span>Entre em contato com o <a href="mailto:suporte@Sistema.com">suporte</a> se precisar de
                        ajuda</span>
                </li>
            </ul>
        </div>
    ...
    console.log('Sistema - Página de erro 404 carregada');
