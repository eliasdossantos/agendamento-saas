...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= route('servico.create') ?>" class="btn btn-primary btn-sm float-right"><i
                                        ...
                                        <div class="btn-group dropup">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="<?= route('servico.show', ['id' => $servico->id]) ?>">
                                                    Visualizar
                                                </a>
                                                <a class="dropdown-item"
                                                    href="<?= route('servico.edit', ['id' => $servico->id]) ?>">
                                                    Editar
                                                </a>
                                                <!-- Botão de Ativar / Desativar -->
                                                <form action="<?= route('servico.verstatus', ['id' => $servico->id]) ?>"
                                                ...
                                                <button type="button" class="dropdown-item text-danger"
                                                    ...
                                                    data-action="<?= route('servico.destroy', ['id' => $servico->id]) ?>"
